...
class SIDS extends StatefulWidget {
  const SIDS({
    Key? key,
  }) : super(key: key);

  @override
  _SIDSState createState() => _SIDSState();
}

class _SIDSState extends State<SIDS> with SingleTickerProviderStateMixin {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8.0),
            const Text(
              'Keep the baby\'s sleep area in the same room where you sleep for at least the first six months.',
              style: TextStyle(
                fontSize: 16,
                height: 1.6,
                color: Color(0xFFC5D6FF),
            ...
            const SizedBox(height: 8.0),
            const Text(
              'Avoid smoking during pregnancy and after birth. Keep the baby away from smoke.',
              style: TextStyle(
                fontSize: 16,
                height: 1.6,
                color: Color(0xFFC5D6FF),
