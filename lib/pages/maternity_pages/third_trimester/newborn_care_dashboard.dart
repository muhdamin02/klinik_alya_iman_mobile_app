...
class NewbornCareDashboard extends StatefulWidget {
  User user;
  Profile profile;
  bool autoImplyLeading;

  NewbornCareDashboard({
    Key? key,
    required this.user,
  ...
  _NewbornCareDashboardState createState() => _NewbornCareDashboardState();
}

class _NewbornCareDashboardState extends State<NewbornCareDashboard> {
  @override
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => NewbornCarePage(
                                user: widget.user,
